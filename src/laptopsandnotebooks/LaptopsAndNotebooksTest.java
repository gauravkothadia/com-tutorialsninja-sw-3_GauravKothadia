...
public class LaptopsAndNotebooksTest extends Utility {
    ...
    public void verifyProductsPriceDisplayHighToLowSuccessfully() throws InterruptedException {
        ...
        List<WebElement> beforeFilterProductPrice = findMultipleElements(By.xpath("//div[@class='product-layout product-grid col-lg-4 col-md-4 col-sm-6 col-xs-12']//div[1]//div[2]//div[1]//p//span[@class='price-tax']"));
        ...
        List<WebElement> afterFilterProductPrice = findMultipleElements(By.xpath("//div[@class='product-layout product-grid col-lg-4 col-md-4 col-sm-6 col-xs-12']//div[1]//div[2]//div[1]//p//span[@class='price-tax']"));
