 ...
 */
    ...
    public void verifyThatUserRegisterAccountSuccessfully() {
        ...
        sendTextToElement(By.id("input-firstname"), "Gaurav");//Enter First Name
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully() {
        ...
        Assert.assertEquals("My Account",getTextFromElement(By.xpath("//h2[contains(text(),'My Account')]"))); //Verify text “My Account”

        mouseHoverToElementAndClick(By.xpath("//span[contains(text(),'My Account')]"));//Click on My Account Link

        selectMyAccountOptions("Logout");

        Assert.assertEquals("Account Logout",getTextFromElement(By.xpath("//h1[contains(text(),'Account Logout')]")));//Verify the text “Account Logout”
